...
public:
	...
	static void createToggleButton(const char *text, CCPoint position, float boxScale, float labelScale, CCObject *baseclass, cocos2d::SEL_MenuHandler callback, CCMenu *menu, bool toggled, bool enabled);
	static void createLabels(CCNode* base, CCPoint pos, bool logNames);
